...
public class HospitalTest {
    ...
    Janitor janitor = new Janitor("3", "janitor name", "maturnity wing", true);

    @Test
    public void shuldBeAbleToHireADoctor(){
    ...
    @Test
    public void shouldBeAbleToHireDrNurseJanitor(){
        underTest.hire(doctor);
    ...
    @Test
    public void shouldBeAbleToHireEmployees(){
        underTest.hire(doctor);
        underTest.hire(nurse);
        underTest.hire(janitor);
